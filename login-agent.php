...
if(isset($_POST["username"]) && isset($_POST["password"])){
    ...
    // Here, you should perform authentication with the provided username and password.
    // For demonstration purposes, I'm just setting the username in session.
...
<div class="container mt-5">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    Welcome back, <?php echo $_SESSION["username"]?>~Agent! 
                </div>
                <div class="card-body">
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
        <h1 class="heading ">Welcome to AgencyLogin </h1>
            <div class="card">
                <div class="card-header">
                    Login
                </div>
